        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <h5 class="brand-name">{{$webSetting ? "$webSetting->website_name":"Website Name"}}</h5>
                </div>
                <div class="col-md-5 my-auto">
                    <form role="search" action="{{url('search')}}" method="GET">
                        <div class="input-group">
                            <input type="search" name="search" value="{{\Illuminate\Support\Facades\Request::get('search')}}" placeholder="Search your product" class="form-control" />
                ...
                <div class="col-md-5 my-auto">
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="{{url('/show-carts')}}">
